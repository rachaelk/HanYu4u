...
#define kSpaceLabel @" "
//#define kChar @[ @"我", @"你", @"他", @" ", @" ", @" ", @" ", @" ", @"乐", @"吃", @"看", @" ", @"喝", @"书", @"早", @" ", @"电", @"听", @" ", @" ", @"视", @" ", @" ", @"啡", @" ", @"饭", @"音", @" ", @"在", @"。" ]
//#define kChar_shift @[ @"有", @"是", @"不", @"个", @"唱", @"报纸", @"歌", @"酒", @"张", @"瓶", @"位", @"支", @"杯", @"百", @"快", @"两", @"千", @"万", @"钱", @"饿", @"一", @"二", @"三", @"四", @"五", @"六", @"七", @"八", @"九", @"十" ]
//#define kChar_alt @[ @"买", @"卖", @"东", @"西", @"平", @"果", @"笑", @"很", @"就", @"这", @"那", @"知道", @"爸爸", @"妈妈", @"哥哥", @"弟弟", @"姐姐", @"妹妹", @"够", @"猫", @"笑", @"然", @"后", @"以", @"前", @"老", @"事", @"大", @"跑", @"步" ]
...
- (id)init {
	...
	[self loadCharactersWithArray:[GameState sharedInstance].keyboard_characters];
...
- (IBAction)shiftPressed:(id)sender {
	...
	if (!self.isShifted) {
		...
		[self loadCharactersWithArray:[GameState sharedInstance].keyboard_characters_shift];
        [self.altButton setTitle:kAltLabel forState:UIControlStateNormal];
	}
}
...
- (IBAction)altPressed:(id)sender {
	...
	if ([button.titleLabel.text isEqualToString:kAltLabel]) {
		[self loadCharactersWithArray:[GameState sharedInstance].keyboard_characters_alt];
        [self.altButton setTitle:kAltLabel forState:UIControlStateNormal];
	}
	else {
		[self loadCharactersWithArray:[GameState sharedInstance].keyboard_characters];
