...
-(id)initWithSize:(CGSize)size {
    if (self = [super initWithSize:size]) {
        ...
        _sentence1b.position = CGPointMake((_sentence1a.position.x) + 3*abs(buffer* _sentence1a.frame.size.width - pad0.frame.size.width), _sentence1a.position.y);
        ...
        _sentence1d.position = CGPointMake((_sentence1c.position.x)+   abs(buffer* _sentence1c.frame.size.width - pad2.frame.size.width), _sentence1a.position.y);
        ...
        _sentence5c.position = CGPointMake(_sentence1d.position.x, _sentence5a.position.y);
        ...
        _sentence6c.position = CGPointMake(_sentence1d.position.x, _sentence2c.position.y);
        ...
        _sentence7c.position = CGPointMake(_sentence1d.position.x, _sentence3c.position.y);
        ...
        _sentence8c.position = CGPointMake(_sentence1d.position.x, _sentence4c.position.y);
    ...
    for (UITouch *touch in touches) {
        ...
        for (SKNode *node in nodes) {
            ...
            /*if( [node.name isEqualToString:@"dialog_start10"]){
                ...
                Dialog10 *newScene = [Dialog10 sceneWithSize:spriteView.bounds.size];
            ...
            if( [node.name isEqualToString:@"change_page"]){
                ...
                if([_change_page.text isEqualToString: @"上页"]){
                ...
                else if ([_change_page.text isEqualToString: @"下页"]){
            ...
            // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            if(([node.name isEqualToString:@"yigong0"])&& (node.hidden == false)) {
                [self show_chinese_translation:@"一共" pinyin:@"yīgòng" english:@"all together" touch_loc:touchLocationInView ];
            ...
            if (([node.name isEqualToString:@"you"])&& (node.hidden == false)){
                ...
                [self show_chinese_translation:@"有" pinyin:@"yǒu" english:@"have/exists" touch_loc:touchLocationInView ];
            ...
            if (([node.name isEqualToString:@"duoshao"])&& (node.hidden == false)){
                [self show_chinese_translation:@"多少" pinyin:@"duōshǎo" english:@"how many" touch_loc:touchLocationInView ];
                
            }
            
            if (([node.name isEqualToString:@"woyou"])&& (node.hidden == false)){
                [self show_chinese_translation:@"我有" pinyin:@"wǒ yǒu" english:@"I have" touch_loc:touchLocationInView ];
                
            }
            
            if(([node.name isEqualToString:@"tayou"] || [node.name isEqualToString:@"tayou3"]|| [node.name isEqualToString:@"tayou4"]|| [node.name isEqualToString:@"tayou5"] ) && (node.hidden == false)) {
                [self show_chinese_translation:@"他有" pinyin:@"tā yǒu" english:@"he has" touch_loc:touchLocationInView ];
                
                
            }
            
            if (([node.name isEqualToString:@"san1"] || [node.name isEqualToString:@"san5"] || [node.name isEqualToString:@"san6"])&& (node.hidden == false)){
                [self show_chinese_translation:@"三" pinyin:@"sān" english:@"three" touch_loc:touchLocationInView ];
                
            }
            if (([node.name isEqualToString:@"ben"] || [node.name isEqualToString:@"ben4"])&& (node.hidden == false)){
                [self show_chinese_translation:@"本" pinyin:@"běn" english:@"measure word: book(s)" touch_loc:touchLocationInView ];
                
            }
            if (([node.name isEqualToString:@"shu"] || [node.name isEqualToString:@"shu4"])&& (node.hidden == false)){
                [self show_chinese_translation:@"书" pinyin:@"shū" english:@"book(s)" touch_loc:touchLocationInView ];
                
            }
            
            if (([node.name isEqualToString:@"yi2"])&& (node.hidden == false)){
                [self show_chinese_translation:@"一" pinyin:@"yī" english:@"a (one)" touch_loc:touchLocationInView ];
                
            }
            if (([node.name isEqualToString:@"bei2"] || [node.name isEqualToString:@"bei5"] || [node.name isEqualToString:@"bei6"])&& (node.hidden == false)){
                [self show_chinese_translation:@"杯" pinyin:@"bēi" english:@"measure word:cup(s)" touch_loc:touchLocationInView ];
                
            }
            
            if (([node.name isEqualToString:@"shui5"] || [node.name isEqualToString:@"shui6"] )&& (node.hidden == false)){
                [self show_chinese_translation:@"水" pinyin:@"shuǐ" english:@"water" touch_loc:touchLocationInView ];
                
            }
            if (([node.name isEqualToString:@"cha"])&& (node.hidden == false)){
                [self show_chinese_translation:@"茶" pinyin:@"chá" english:@"tea" touch_loc:touchLocationInView ];
                
            }
            
            if (([node.name isEqualToString:@"liang"])&& (node.hidden == false)){
                [self show_chinese_translation:@"两" pinyin:@"liǎng" english:@"two (amount!)" touch_loc:touchLocationInView ];
                
            }
            if (([node.name isEqualToString:@"ge"])&& (node.hidden == false)){
                [self show_chinese_translation:@"个" pinyin:@"ge" english:@"measure word (for most things in general)" touch_loc:touchLocationInView ];
                
            }
            
            if (([node.name isEqualToString:@"shouji"])&& (node.hidden == false)){
                [self show_chinese_translation:@"手机" pinyin:@"shǒujī" english:@"cell phone(s)" touch_loc:touchLocationInView ];
                
            }
            if (([node.name isEqualToString:@"wu"])&& (node.hidden == false)){
                [self show_chinese_translation:@"五" pinyin:@"wǔ" english:@"five" touch_loc:touchLocationInView ];
